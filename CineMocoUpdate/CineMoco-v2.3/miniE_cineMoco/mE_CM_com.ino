...
boolean com_motor_bouncing;
boolean com_motor_powered;


// ===================================================================================

void    com_set_sync_flag()                      { com_status |= B10000000; }
boolean com_is_sync_flag()                       { return com_status & B10000000; }
void    com_delete_sync_flag()                   { bitClear(com_status, 7); } // B01111111

void    com_set_start_flag()                     { com_status |= B00010000; }
boolean com_is_start_flag()                      { return com_status & B00010000; }
void    com_delete_start_flag()                  { bitClear(com_status, 4); } // B11101111

void    com_set_stop_flag()                      { setBit(com_status, BIT_6); }
boolean com_is_stop_flag()                       { return isBit(com_status, BIT_6); }
void    com_delete_stop_flag()                   { deleteBit(com_status, BIT_6); } // B1011 1111


void    com_set_manual_override_start_flag()     { com_status |= B00100000; }
boolean com_is_manual_override_start_flag()      { return com_status & B00100000;}
void    com_delete_manual_override_start_flag()  { bitClear(com_status, 5); } // B1101 1111
...
void com_handle_events() {
  ...
  if (command == MOCOM_COMMAND_GET_MOTOR_DATA) {
    ...
    com.addMotor(MOCOM_MOTOR_TYPE_LINEAR);
    com.sendDone();
  ...
  // ---------------------
    ...
    switch (code) {
      ...
      // video bouncing
      case 156 :  {
                    com.sendCommand(MOCOM_MASTER_ID, MOCOM_COMMAND_DATA, 156, motor_is_bouncing());
                    break;
                  }
  ...
  // ---------------------
    ...
    switch (code) {
      ...
      case 156 :   {
                    ...
                    if (bouncing) {
                      motor_key_status |= B00100000;
                    } else {
                      bitClear(motor_key_status, 5); // B11011111
                    }
...
// ===================================================================================
boolean com_is_start_keyframe_set() {
  if (com_slave_pos == 0) {
...
// ===================================================================================
boolean com_is_end_keyframe_set() {
  if (com_slave_pos == 0) {
...
// ===================================================================================
// sends the editied item data back if needed
// ===================================================================================
void com_send_data_back(byte code) {
  ...
  if (com.isMaster()) {
    ...
    if (com_slave_pos != 0) {
      ...
      switch(code) {
        ...
        // bouncing
        case 156: {
                    com.sendCommand(com.getSlaveID(), MOCOM_COMMAND_DATA, 156, (byte) (motor_is_bouncing() > 0));
                    break;
                  }
  
      }      
    
    } // end: slave is selected 
  
   
    // send these in any case: 
...
void com_save_master_settings() {
  ...
  com_motor_bouncing = motor_is_bouncing();
...
void com_restore_master_settings() {
  ...
  if (com_motor_bouncing) {
    setBit(motor_status, BIT_5);
  } else {
    deleteBit(motor_status, BIT_5);
  }
