    ...
    (c) 2014 Airic Lenz, C.A. Church
    
    The 1st version of this code, deal+ing with core functionalities, 
...
int           exposure_values[]      = { 66, 77, 100, 125, 166, 200, 250, 300, 400, 500, 600, 800, 1000, 1300, 1600, 2000, 2500, 3200, 4000 };        
...
// B2 =
// B1 =
// B0 = Focus line high or low while exposing (camera type)
...
prog_char string_66 [] PROGMEM = "Device/Mot";
...
prog_char string_130[] PROGMEM = { char(130), char(130), char(0) }; // < + null termination
prog_char string_131[] PROGMEM = { char(129), char(129), char(0) }; // > + null termination
...
prog_char string_143[] PROGMEM = { char(128), ' ' , '~', char(0) }; // v -> + null termination
...
prog_char string_156[] PROGMEM = "Bouncing";
...
void setup() {
  ...
  // set motor to microstpes
  digitalWrite(DEF_MOTOR_MS1_PIN, HIGH);
  digitalWrite(DEF_MOTOR_MS2_PIN, HIGH);
  ...
  if ((eeprom_is_config_saved()) && 
    ...
    bitClear(motor_key_status, 7);    // start keyframe is set - B01111111
    bitClear(motor_key_status, 6);    // end keyframe is set   - B10111111
